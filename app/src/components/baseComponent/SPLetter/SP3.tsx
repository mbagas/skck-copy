      ...
      <Document>
        <Page size="A4">
          <View style={styles.body}>
            ...
            <Text style={styles.text}>
              Sehubungan dengan total point Siswa telah mencapai syarat untuk dikeluarkannya SP 3
              Sekolah memberitahukan kepada Orang Tua/Wali Siswa/i, bahwa Siswa dengan data di atas
              akan ditindaklanjuti oleh Kepala sekolah bersama kedua orang tua dari siswa tersebut.
              Orang tua diharapkan untuk dapat hadir dalam proses pemulangan siswa kepada orang tua.
            </Text>
            <Text style={styles.text}>
