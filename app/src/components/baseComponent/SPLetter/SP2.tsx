      ...
      <Document>
        <Page size="A4">
          <View style={styles.body}>
            ...
            <Text style={styles.text}>
              Sehubungan dengan total point Siswa telah mencapai syarat untuk dikeluarkannya SP 2
              Sekolah memberitahukan kepada Orang Tua/Wali Siswa/i, bahwa Siswa dengan data di atas
              akan menjalani proses pembinaan oleh Wakil kepala sekolah dan kedua orang tua dari
              Siswa tersebut diharapkan bisa hadir mengikuti sesi bimbingan tersebut.
            </Text>
            <Text style={styles.text}>
